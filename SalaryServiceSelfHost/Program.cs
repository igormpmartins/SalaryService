using SalaryServiceLibrary;
using System;
using System.ServiceModel;
using System.ServiceModel.Description;

namespace SalaryServiceSelfHost
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var serviceHost = new ServiceHost(typeof(EmployeeSalary), new Uri[] { tcpBaseAddress });

            var tcpBinding = new NetTcpBinding { TransactionFlow = true };
            var serviceEndpoint = serviceHost.AddServiceEndpoint(typeof(IEmployeeSalary), tcpBinding, baseUrlTcp);
